...
from image_processor.common_helper import create_int_metavar
from image_processor.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from image_processor.face_analyser import scale_face
from image_processor.face_helper import paste_back, warp_face_by_face_landmark_5
from image_processor.face_masker import create_box_mask, create_occlusion_mask
from image_processor.face_selector import select_faces
from image_processor.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from image_processor.processors.live_portrait import create_rotation, limit_expression
from image_processor.processors.modules.expression_restorer import choices as expression_restorer_choices
from image_processor.processors.modules.expression_restorer.types import ExpressionRestorerInputs
from image_processor.processors.types import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw, ProcessorOutputs
from image_processor.program_helper import find_argument_group
from image_processor.thread_helper import conditional_thread_semaphore, thread_semaphore
from image_processor.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from image_processor.vision import read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		image_processor.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor', 'expression_restorer_areas' ])
