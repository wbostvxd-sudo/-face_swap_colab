...
from image_processor.processors.modules.frame_colorizer import choices as frame_colorizer_choices
from image_processor.processors.modules.frame_colorizer.types import FrameColorizerInputs
...
from image_processor.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from image_processor.vision import blend_frame, read_static_image, read_static_video_frame, unpack_resolution
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		image_processor.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
