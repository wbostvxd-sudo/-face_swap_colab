...
from image_processor import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager
from image_processor.face_analyser import scale_face
from image_processor.face_helper import warp_face_by_face_landmark_5
...
from image_processor.filesystem import in_directory, is_image, is_video, same_file_extension
from image_processor.processors.modules.face_debugger import choices as face_debugger_choices
from image_processor.processors.modules.face_debugger.types import FaceDebuggerInputs
...
from image_processor.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		image_processor.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
