...
from image_processor import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
from image_processor.common_helper import is_macos
...
from image_processor.normalizer import normalize_color
from image_processor.processors.modules.background_remover import choices as background_remover_choices
from image_processor.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from image_processor.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		image_processor.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_color' ])
