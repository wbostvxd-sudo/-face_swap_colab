...
from image_processor import benchmarker, cli_helper, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, hash_helper, logger, state_manager, translator, voice_extractor
from image_processor.args import apply_args, collect_job_args, reduce_job_args, reduce_step_args
from image_processor.download import conditional_download_hashes, conditional_download_sources
from image_processor.exit_helper import hard_exit, signal_exit
from image_processor.filesystem import get_file_extension, get_file_name, is_image, is_video, resolve_file_paths, resolve_file_pattern
from image_processor.jobs import job_helper, job_manager, job_runner
from image_processor.jobs.job_list import compose_job_list
from image_processor.memory import limit_system_memory
from image_processor.processors.core import get_processors_modules
from image_processor.program import create_program
from image_processor.program_helper import validate_args
from image_processor.types import Args, ErrorCode
from image_processor.workflows import image_to_image, image_to_video
...
def route(args : Args) -> None:
	...
	if state_manager.get_item('command') == 'run':
		import image_processor.uis.core as ui
