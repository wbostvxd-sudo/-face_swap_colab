...
from image_processor import content_analyser, core, state_manager
from image_processor.cli_helper import render_table
from image_processor.download import conditional_download, resolve_download_url
from image_processor.face_store import clear_static_faces
from image_processor.filesystem import get_file_extension
from image_processor.types import BenchmarkCycleSet
from image_processor.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ image_processor.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in image_processor.choices.benchmark_set ]
