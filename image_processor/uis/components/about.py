...
from image_processor import metadata, translator
	...
	[
		{
			...
			'url': 'https://fund.image_processor.io'
		},
		{
			'translator': translator.get('about.subscribe'),
			'url': 'https://subscribe.image_processor.io'
		},
		{
			'translator': translator.get('about.join'),
			'url': 'https://join.image_processor.io'
		}
	])
