...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(image_processor.choices.execution_thread_count_range),
		minimum = image_processor.choices.execution_thread_count_range[0],
		maximum = image_processor.choices.execution_thread_count_range[-1]
	)
