...
from image_processor.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = image_processor.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(image_processor.choices.system_memory_limit_range),
		minimum = image_processor.choices.system_memory_limit_range[0],
		maximum = image_processor.choices.system_memory_limit_range[-1],
