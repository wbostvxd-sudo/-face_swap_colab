...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/image_processor/image_processor-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
